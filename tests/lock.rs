...
fn test_pubkey_lock_wast() {
    ...
    { // lock
        ...
        assert_eq!(context.rstack.top(), Some(&vm::Value::Success(1)));
    }
}
...
fn test_preimage_lock_wast() {
    ...
    { // unlock
        ...
        assert_eq!(context.pstack.peek(1), Some(&vm::Value::Bin(b"blah".to_vec())));
    }
    ...
    { // lock
        ...
        assert_eq!(context.rstack.top(), Some(&vm::Value::Success(2)));
    }
}
